...
TrigarQR::TrigarQR(D3DXVECTOR3* position, D3DXVECTOR3* boxLength)
{
...
bool TrigarQR::Initialize()
{
	if (!m_textureQR.Load("../Graphics/QR_white.png"))
	{
		return false;
	}

	if (!m_textureIconQR.Load("../Graphics/Icon_QR.png"))
	{
		return false;
	}

	if (!m_textureGettingQR.Load("../Graphics/gettingQR.png"))
	{
		return false;
	}
